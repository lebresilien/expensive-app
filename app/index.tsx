import { SafeAreaView, StyleSheet, Image, StatusBar, TouchableOpacity } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ThemedView style={styles.skip_block}>
        <TouchableOpacity onPress={() => console.log('')} style={{flex: 1}}>
        ...
        <TouchableOpacity onPress={() => console.log('')} style={{flex: 1}}>
          <ThemedView style={styles.next_button}>
            <ThemedText style={styles.textWhite} onPress={() => goToPage(position + 1)}>
